...
/**
 * Clase utilitaria para operaciones con JSON Web Tokens (JWT). Proporciona
 * métodos para generar, validar y extraer información de tokens JWT.
 */
@Component
public class JwtUtil {
	...
	/**
	 * Clave secreta utilizada para firmar los tokens JWT. Se puede configurar en
