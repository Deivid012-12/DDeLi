...
/**
 * Configuración de OpenAPI (Swagger) para documentar la API REST. Esta clase
 * define la información general de la API, esquemas de seguridad, y componentes
 * reutilizables para la documentación.
 */
@Configuration
