...
public class PlanSuscripcionDTO {
	...
	private ArrayList<SuscripcionDTO> suscripciones = new ArrayList<>();
	...
	public PlanSuscripcionDTO(Long idPlan, String nombre, double precioMensual, double costoAdicional,
			ArrayList<SuscripcionDTO> suscripciones) {
		super();
		this.idPlan = idPlan;
		this.nombre = nombre;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PlanSuscripcionDTO other = (PlanSuscripcionDTO) obj;
	 ...
	 */
	public ArrayList<SuscripcionDTO> getSuscripciones() {
	 ...
	 */
	public void setSuscripciones(ArrayList<SuscripcionDTO> suscripciones) {
		this.suscripciones = suscripciones;
	}
